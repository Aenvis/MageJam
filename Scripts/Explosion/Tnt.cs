...
public class Tnt : MonoBehaviour
{
    ...
    public IEnumerator Explode(float seconds)
    {
        ...
        switch(tntSO.explosiveType)
        {
            case ExplosivesTypes.WEAK:
                SoundManager.Instance.PlaySound("wybuchS");
                break;
            case ExplosivesTypes.MID:
                SoundManager.Instance.PlaySound("wybuchM");
                break;
            case ExplosivesTypes.STRONG:
                SoundManager.Instance.PlaySound("wybuchL");
                break;
        }
